...
public class HashMap254<Key, Value> 
{
	...
	private int myhash(Key key) {
		...
		int base = 31;		//bonus question change to 37 for efficient time	
		for (int i = 0; i < k.length(); i++)
			...
			hash = hash*base + k.charAt(i);	//task 2		//where base 2 = 31
